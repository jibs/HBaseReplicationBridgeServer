 ...
 *
 */
public class HB96ReplicationSinkImpl implements ReplicationSink {

  private static final Log LOG = LogFactory.getLog(HB96ReplicationSinkImpl.class);
   ...
   */
  public HB96ReplicationSinkImpl(Configuration conf)
      throws IOException {
